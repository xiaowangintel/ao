...
# Ops that should preserve the InferenceWeightWrapperBaseTensor subclass
...
class InferenceWeightWrapperBaseTensor(TorchAOBaseTensor):
    """
    Abstract base class for inference quantization tensor subclasses.
...
class Float8InferenceWeightWrapperTensor(InferenceWeightWrapperBaseTensor):
    """
    Float8 dynamic activation + static weight quantization for MoE expert weights.
